                    ...
                    <div class="card-body">
                        <form action="{{ route('obat.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="kemasan" name="kemasan" class="form-control" placeholder="Contoh: Strip, Botol, Tube" value="{{ old('kemasan') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" id="harga" name="harga" class="form-control" min="0" step="1" value="{{ old('harga') }}" required>
                            </div>
